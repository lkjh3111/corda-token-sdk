...
@StartableByRPC
@InitiatingFlow
class SellHouseFlow(val buyer: Party, val linearId: UniqueIdentifier) : FlowLogic<SignedTransaction>() {
    @Suspendable
    override fun call(): SignedTransaction {
        ...
        addMoveNonFungibleTokens(txBuilder, serviceHub, housePtr, buyer)
        ...
        //return subFlow(IdentitySyncFlow.Send(session, txBuilder.toWireTransaction(serviceHub)))
    ...
    class SellHouseFlowHandler(val otherSession: FlowSession) : FlowLogic<Unit>() {
        ...
        override fun call() {
            ...
            //subFlow(Identity.Receive(otherSession))
